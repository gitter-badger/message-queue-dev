...
class BuildExtensionsPass implements CompilerPassInterface
{
    ...
    {
        $tags = $container->findTaggedServiceIds('formapro_message_queue.consumption.extension');
        ...
        $container->getDefinition('formapro_message_queue.consumption.extensions')->replaceArgument(0, $flatExtensions);
    }
}
