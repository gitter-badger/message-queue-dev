...
class Job
{
    const STATUS_NEW = 'formapro.job_queue.status.new';
    const STATUS_RUNNING = 'formapro.job_queue.status.running';
    const STATUS_SUCCESS = 'formapro.job_queue.status.success';
    const STATUS_FAILED = 'formapro.job_queue.status.failed';
    const STATUS_CANCELLED = 'formapro.job_queue.status.cancelled';
