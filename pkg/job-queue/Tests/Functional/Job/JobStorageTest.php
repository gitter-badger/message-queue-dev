<?php
namespace Formapro\JobQueue\Tests\Functional\Job;
...
class JobStorageTest extends WebTestCase
{
    ...
    /**
     * @return \Formapro\JobQueue\JobStorage
     */
    private function getJobStorage()
    {
        return new JobStorage($this->container->get('doctrine'), Job::class, 'formapro_job_queue_unique');
    }
}
